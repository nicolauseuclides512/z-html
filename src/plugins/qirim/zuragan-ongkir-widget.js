(function () {
    ...
    function init($) {
        ...
        let widgetStyle = '<link rel="stylesheet" type="text/css" href="widget-min.css">';
        ...
        let typeaheadScript = '<script type="text/javascript" src="https://qirim.id/js/bootstrap3-typeahead.js"></script>';
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 align-center" style="padding: 10px;">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <label for="zuragan-weight">
                                        <img src="https://qirim.id/asset_ongkir/weight_active.png" class="img-thumbnail1">
                                    </label>
                                </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 align-center" style="padding: 10px">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <label for="zuragan-city-from">
                                        <img src="https://qirim.id/asset_ongkir/boxOpen_active.png" class="img-thumbnail1">
                                    </label>
                                </div>
                                <div class="col-md-10 col-sm-10 col-xs-10">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 align-center" style="padding: 10px">
                                <div class="col-md-2 col-sm-2 col-xs-2">
                                    <label for="zuragan-city-destination">
                                        <img src="https://qirim.id/asset_ongkir/boxClose_active.png" class="img-thumbnail1">
                                    </label>
                                </div>
                                <div class="col-md-10 col-sm-10 col-xs-10">
                        ...
                        for (var j = 0; j < response.data.results.length; j++) {
                            ...
                            $('.ongkir-result-table > tbody:last-child').append(`
                                <tr>
                                    ...
                                    <td style="color: blue; font-size: large; vertical-align:middle; text-align:left"><sup style="color:#4d4d4d">Rp. </sup><b>` + formatCurrency(response.data.results[j].value.toFixed(0)) + `</b></td>
                                </tr>`
                            );
                        }
                    } else {
